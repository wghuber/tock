...
pub struct RngComponent {
    ...
    trng: &'static Entropy32<'static>,
}

impl RngComponent {
    pub fn new(board_kernel: &'static kernel::Kernel, trng: &'static Entropy32<'static>) -> RngComponent {
        RngComponent {
...
impl Component2 for RngComponent {
    type InputBuffer = ();
    type Output = &'static rng::RngDriver<'static>;

    unsafe fn finalize(&mut self, _static_buffer: ()) -> Self::Output {
