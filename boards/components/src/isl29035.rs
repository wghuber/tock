...
pub struct Isl29035Component<A: 'static + time::Alarm> {
    i2c_mux: &'static MuxI2C<'static>,
    alarm_mux: &'static MuxAlarm<'static, A>,
}

impl<A: 'static + time::Alarm> Isl29035Component<A> {
    pub fn new(
...
impl<A: 'static + time::Alarm> Component2 for Isl29035Component<A> {
    ...
    unsafe fn finalize(&mut self,
     static_buffer: Self::InputBuffer
        ) -> Self::Output {
        let isl29035_i2c = static_init!(I2CDevice, I2CDevice::new(self.i2c_mux, 0x44));
        let isl29035_virtual_alarm = static_init_h!(
            static_buffer.0,
            VirtualMuxAlarm<'static, A>,
            VirtualMuxAlarm::new(self.alarm_mux)
        );
        let isl29035 = static_init_h!(
            static_buffer.1,
...
pub struct AmbientLightComponent<A: 'static + time::Alarm> {
    board_kernel: &'static kernel::Kernel,
    i2c_mux: &'static MuxI2C<'static>,
    alarm_mux: &'static MuxAlarm<'static, A>,
}

impl<A: 'static + time::Alarm> AmbientLightComponent<A> {
    pub fn new(
        board_kernel: &'static kernel::Kernel,
        i2c: &'static MuxI2C<'static>,
        alarm: &'static MuxAlarm<'static, A>,
...
impl<A: 'static + time::Alarm> Component2 for AmbientLightComponent<A> {
    type InputBuffer = (&'static mut Option<VirtualMuxAlarm<'static, A>>,
              &'static mut Option<Isl29035<'static, VirtualMuxAlarm<'static, A>>>
              );
